        ...
        <div class="box">
          ...
          <form role="form" action="<?php base_url('users/update') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="brands">Brands</label>
                  <?php $brand_name = get_perticular_field_value('brands','name',"and id='".$product_data['brand_id']."'"); ?>
                 <input name="brands" class="form-control" list="brand" value="<?php echo $brand_name; ?>">
                  <datalist id="brand">
                  <?php foreach ($brands as $k => $v): ?>
               ...
               <!-- <div class="form-group">
                ...
                <div class="form-group">
                  <label for="category">Category</label>
                  <?php $category_data = get_perticular_field_value('categories','name',"and id='".$product_data['category_id']."'"); ?>
                  <input name="category" class="form-control" list="categorys" value="<?php echo $category_data; ?>">
