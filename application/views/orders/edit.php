          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                      ...
                      <?php foreach ($order_data['order_item'] as $key => $val): ?>
                       ...
                       <tr id="row_<?php echo $x; ?>">
                         <td>
                          ...
                          <td>
                            <input type="text" name="rate[]" id="rate_<?php echo $x; ?>" class="form-control"  value="<?php echo $val['rate'] ?>" onkeyup="getTotal(<?php echo $x; ?>)" autocomplete="off">
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                  <label for="net_amount" class="col-sm-5 control-label">Less Round Off</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="pay_amount" value="<?php echo $order_data['order']['less_amount'] ?>" name="pay_amount" onkeyup="getSubTotal();" autocomplete="off">
                     </div>
                  </div>

                  <div class="form-group">
                    <label for="net_amount" class="col-sm-5 control-label">Payable Amount</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="payble_amount" value="<?php echo $order_data['order']['payble_amount'] ?>" name="payble_amount" readonly autocomplete="off">
                      <input type="hidden" class="form-control" id="payble_amount_value" value="<?php echo $order_data['order']['payble_amount'] ?>" name="payble_amount_value" readonly autocomplete="off">
                    </div>
                  </div>
              ...
              // console.log(reponse.x);
               var html = '<tr id="row_'+row_id+'">'+
                   '<td>\
                    ...
                    '<td><input type="text" name="rate[]" id="rate_'+row_id+'" onkeyup="getTotal('+row_id+')" class="form-control" disabled><input type="hidden" name="rate_value[]" id="rate_value_'+row_id+'" class="form-control"><input type="hidden" name="cost_price_value[]" id="cost_price_value_'+row_id+'" class="form-control" autocomplete="off"></td>'+
...
function getSubTotal(){
    ...
    var amount2 = Number($('#payble_amount_value').val());
    if(amount<=0){
      $("#payble_amount").val(amount2);

    }else{
        $("#payble_amount").val(Number(amount2)-Number(amount));
    }
  }
...
function getProductDataBySKU(row_id)
  ...
  function subAmount() {
    ...
    if(discount) {
      ...
      $('#payble_amount').val(grandTotal);
      $('#payble_amount_value').val(grandTotal);
    } else {
      $("#net_amount").val(totalAmount);
      $("#net_amount_value").val(totalAmount);
      $("#payble_amount").val(totalAmount);
      $("#payble_amount_value").val(totalAmount);
