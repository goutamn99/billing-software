                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                 ...
                 <!-- <div class="form-group">
                  ...
                  <label for="net_amount" class="col-sm-5 control-label">Less Round Off</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="pay_amount" name="pay_amount" onkeyup="getSubTotal();" autocomplete="off">
                     </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="payble_amount" name="payble_amount" readonly autocomplete="off">
                      <input type="hidden" class="form-control" id="payble_amount_value" name="payble_amount_value" readonly autocomplete="off">
                    </div>
                  </div>
