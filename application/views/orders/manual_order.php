      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Manually Add Order</h3>
          </div>
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('orders/manual') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-md-4 col-xs-12 pull pull-left">
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="number" class="form-control" id="inv_no" name="inv_no" placeholder="Enter Invoice Number" autocomplete="off" />
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      ...
                      <textarea class="form-control" id="customer_address" name="customer_address" placeholder="Enter Customer Address"></textarea>
                    </div>
                  </div>
                ...
                <table class="table table-bordered" id="product_info_table">
                  <thead>
                   ...
                   <tbody>
                     <tr id="row_1">
                       <td>
                          <input type="text" name="product_name[]" id="product_name_1" class="form-control" autocomplete="off">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $("#manualOrderNav").addClass('active');
          ...
          success:function(response) {
              ...
              // console.log(reponse.x);
               var html = '<tr id="row_'+row_id+'">'+
                   '<td>'+ 
                     '<input type="text" name="product_name[]" id="product_name_'+row_id+'" class="form-control" autocomplete="off">\
                          '+
                    '</td>'+ 
                    '<td><input type="number" name="qty[]" id="qty_'+row_id+'" class="form-control" onkeyup="getTotal('+row_id+')" min="1"></td>'+
                    '<td><input type="text" name="rate[]" id="rate_'+row_id+'" class="form-control" onkeyup="getTotal('+row_id+')"><input type="hidden" name="rate_value[]" id="rate_value_'+row_id+'" class="form-control"><input type="hidden" name="cost_price_value[]" id="cost_price_value_'+row_id+'" class="form-control" autocomplete="off"></td>'+
  ...
  function getTotal(row = null) {
    if(row) {
      var rate = Number($("#rate_"+row).val());
      $("#rate_value_"+row).val(rate);
